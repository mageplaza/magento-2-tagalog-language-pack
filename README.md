## Magento 2 Tagalog Language Pack
...
```
unzip master.zip app/i18n/Mageplaza/tl_ph
```
...
Unzip the compressed file and upload file `tl_PH.zip` into `app/i18n/mageplaza/tl_PH/tl_PH.csv`
